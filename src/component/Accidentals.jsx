  ...
  return (
    <div className="accidentals-page">
      ...
      <div className="accidentals-card" ref={enharmonicRef}>
        ...
        {/* 🎹 ENHARMONIC PIANO INSERTED */}
       <EnharmonicPiano playNote={playNote} />
...
The white keys on the piano have several names too. For example, the key for the note C is also called B♯. On the piano below, you will find the most common names for the white keys. Click on the piano to listen to the notes:</p>
 <EnharmonicPianoWhite playNote={playNote} />
      </div>
