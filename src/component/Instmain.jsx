...
const InstrumentSection = ({ onPlayNow }) => {
  return (
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-md-3 col-sm-6 mb-4">
            <div className="instrument-onecard">
              ...
              <button className="btn glow-btn" onClick={onPlayNow}>
  Play Now
</button>
          ...
          <div className="col-md-3 col-sm-6 mb-4">
            <div className="instrument-onecard">
              ...
              <button className="btn glow-btn">Open</button>
            </div>
          </div>
          ...
          <div className="col-md-3 col-sm-6 mb-4">
            <div className="instrument-onecard">
              ...
              <button className="btn glow-btn">Start</button>
            </div>
          </div>
